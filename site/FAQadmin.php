 	...
 	<?php include("header.php"); ?>
   	<div class="bg">
        ...
        <form action="#" method="POST">
          ...
          <p>Pour créer votre compte, veuillez suivre les instructions de la FAQ pour la question "Comment faire pour créer un compte ?". Si vous n'arrivez toujours pas a créer votre compte, tant pis.</p>
